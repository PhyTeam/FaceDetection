...
Java_com_example_bbphuc_facedetection_FdActivity_nativeNPDDetect(JNIEnv *env, jclass type,
                                                                 jlong grayImageAddr,
                                                                 jlong addrFaces, jstring jpath_);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_example_bbphuc_facedetection_DetectionBasedTracker_nativeCreateObject
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_example_bbphuc_facedetection_DetectionBasedTracker_nativeDestroyObject
        (JNIEnv *, jclass, jlong);
